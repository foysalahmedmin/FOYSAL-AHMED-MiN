...
const Header = () => {
    ...
    return (
        <header className={`top-0 w-full z-50 fixed lg:static shadow bg-base-100`}>
                ...
                <nav className='flex gap-3 justify-between items-center py-2 '>
                    <label htmlFor="my-drawer-2" className="btn btn-ghost drawer-button lg:hidden">
                        <div className='flex gap-1 items-center'>
                            ...
                            <p>
                                <span className="font-semibold uppercase text-xl"><span className="text-primary">F</span>oysal </span><span className="font-bold text-xl text-primary">.</span>
                            </p>
                        </div>
                    </label>
                    <ul className={`
